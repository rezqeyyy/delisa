...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/dropdown.js', 'resources/js/bidan/sidebar-toggle.js', 'resources/js/bidan/bidan-profile.js'])
</head>
    ...
    <div class="lg:ml-[260px] mx-auto max-w-8xl px-3 sm:px-6 lg:px-8 py-6 lg:py-8">
        ...
        <div class="rounded-2xl bg-white p-6 shadow">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2 sm:gap-3">
                ...
                <input id="photoInput" name="photo" type="file" accept=".svg,image/*" class="hidden"
                    form="profileForm" />
                ...
                <form id="removePhotoForm" action="{{ route('bidan.profile.photo.destroy') }}" method="POST"
                    class="hidden">
                    @csrf
                    @method('DELETE')
                </form>
