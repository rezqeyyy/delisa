        ...
        <div class="w-full max-w-5xl flex bg-white shadow-2xl overflow-hidden rounded-2xl">
            ...
            <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
                <div class="w-full max-w-md">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900 mt-4">Login Pasien</h1>
                    <p class="text-gray-600 mt-1">Masukan NIK dan Nama Lengkap</p>
                    ...
                    <div class="mt-6 flex justify-end text-sm">
                        <a href="{{ route('pasien.register') }}" class="font-medium text-gray-600 hover:text-gray-900">
                            Belum punya akun? <span class="text-[#D91A8B] font-semibold">Daftar disini</span>
                        </a>
                    </div>
                </div>
            </div>
