            ...
            <form action="#" method="POST" class="mt-8 space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Masukan Nama Rumah Sakit" class="mt-1 w-full px-4 py-3 rounded-full border border-[#D91A8B] focus:outline-none focus:ring-[#D91A8B] focus:border-[#D91A8B]">
                    </div>
                </div>
