                ...
                <form id="formTambahPasien" method="POST" action="{{ route('rs.pasien-nifas.store') }}" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            ...
                            <input
                                ...
                                id="nama_pasien"
                                name="nama_pasien"
                                class="block w-full rounded-lg border @error('nama_pasien') border-red-400 @else border-[#E5E5E5] @enderror bg-white px-3 py-2 text-xs sm:text-sm text-[#1D1D1D] shadow-sm focus:border-[#E91E8C] focus:ring-1 focus:ring-[#E91E8C]/30"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input
                                ...
                                name="nik"
                                maxlength="16"
                                class="block w-full rounded-lg border @error('nik') border-red-400 @else border-[#E5E5E5] @enderror bg-white px-3 py-2 text-xs sm:text-sm text-[#1D1D1D] shadow-sm focus:border-[#E91E8C] focus:ring-1 focus:ring-[#E91E8C]/30"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input
                            ...
                            id="no_telepon"
                            name="no_telepon"
                            class="block w-full rounded-lg border @error('no_telepon') border-red-400 @else border-[#E5E5E5] @enderror bg-white px-3 py-2 text-xs sm:text-sm text-[#1D1D1D] shadow-sm focus:border-[#E91E8C] focus:ring-1 focus:ring-[#E91E8C]/30"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            ...
                            <input
                                ...
                                id="provinsi"
                                name="provinsi"
                                class="block w-full rounded-lg border @error('provinsi') border-red-400 @else border-[#E5E5E5] @enderror bg-white px-3 py-2 text-xs sm:text-sm text-[#1D1D1D] shadow-sm focus:border-[#E91E8C] focus:ring-1 focus:ring-[#E91E8C]/30"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input
                                ...
                                id="kota"
                                name="kota"
                                class="block w-full rounded-lg border @error('kota') border-red-400 @else border-[#E5E5E5] @enderror bg-white px-3 py-2 text-xs sm:text-sm text-[#1D1D1D] shadow-sm focus:border-[#E91E8C] focus:ring-1 focus:ring-[#E91E8C]/30"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            ...
                            <input
                                ...
                                id="kecamatan"
                                name="kecamatan"
                                class="block w-full rounded-lg border @error('kecamatan') border-red-400 @else border-[#E5E5E5] @enderror bg-white px-3 py-2 text-xs sm:text-sm text-[#1D1D1D] shadow-sm focus:border-[#E91E8C] focus:ring-1 focus:ring-[#E91E8C]/30"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input
                                ...
                                id="kelurahan"
                                name="kelurahan"
                                class="block w-full rounded-lg border @error('kelurahan') border-red-400 @else border-[#E5E5E5] @enderror bg-white px-3 py-2 text-xs sm:text-sm text-[#1D1D1D] shadow-sm focus:border-[#E91E8C] focus:ring-1 focus:ring-[#E91E8C]/30"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea
                            ...
                            name="domisili"
                            rows="4"
                            class="block w-full rounded-lg border @error('domisili') border-red-400 @else border-[#E5E5E5] @enderror bg-white px-3 py-2 text-xs sm:text-sm text-[#1D1D1D] shadow-sm focus:border-[#E91E8C] focus:ring-1 focus:ring-[#E91E8C]/30"
