                        ...
                        <tbody class="divide-y divide-[#E9E9E9]">
                            @foreach($pasienNifas->anakPasien as $anak)
                                <tr>
                                    ...
                                    <td class="px-3 py-2">
                                        <span
                                            class="inline-flex items-center rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-semibold text-emerald-700">
                ...
                <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                        @foreach(['Hipertensi','Infeksi','KPD','Masalah Plasenta','Inkompetensi Serviks','Masalah Lainnya'] as $item)
                            <label
                                class="flex items-center gap-2 rounded-lg border border-[#E5E5E5] bg-white px-3 py-2 text-xs text-[#4B4B4B] hover:border-[#E91E8C]/60">
                                <input
                                    type="checkbox"
