    ...
    <div class="mt-4 grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-8">
            ...
            <div class="grid md:grid-cols-2 gap-3">
                @if($noVarY)
                    <div class="col-span-2 rounded-xl border border-dashed border-[#E5E7EB] p-4 text-sm text-[#6B7280] bg-[#FAFAFA]">
                        Outcome pada filter ini tidak bervariasi (semua 0 atau 1) atau data terlalu sedikit (&lt;5) sehingga korelasi tidak dapat dihitung. Longgarkan periode/kecamatan untuk melihat hasil.
                    </div>
                @elseif(empty($top))
