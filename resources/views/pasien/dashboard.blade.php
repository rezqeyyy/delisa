...
<body class="bg-[#FFF7FC] min-h-screen p-8">
        ...
        <section class="bg-white rounded-2xl shadow-md p-6">
            <div class="flex flex-wrap items-start gap-4">
                <div class="flex-1 min-w-[240px]">
                    ...
                    <p class="text-[12px] text-[#7C7C7C] mt-1">
                    *Jika status Eklampsia masih kosong, berarti skrining belum selesai terisi
                    </p>
                </div>

                <div class="ml-auto flex items-center gap-3">
                    <form action="{{ route('pasien.dashboard') }}" method="GET" class="flex items-center gap-2">
                        <div class="relative">
                            <select name="status" class="pl-3 pr-9 py-2 rounded-full border border-[#D9D9D9] text-sm focus:outline-none focus:ring-1 focus:ring-[#B9257F]/40">
                        ...
                        <button class="px-4 py-2 rounded-full bg-[#B9257F] text-white text-sm font-medium hover:bg-[#a31f70]">
                            Cari
                        </button>
                    </form>
                    ...
                    @endphp
                    <a href="{{ $ajukanUrl }}"
                    class="px-4 py-2 rounded-full bg-[#B9257F] text-white text-sm font-semibold shadow hover:bg-[#a31f70]">
                    + Ajukan Skrining
                    </a>
                </div>
            </div>
