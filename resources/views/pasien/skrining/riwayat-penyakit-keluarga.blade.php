                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
                        ...
                        <div class="relative">
                            ...
                            <div class="mt-2 hidden peer-checked:block">
                                <input type="text" name="penyakit_keluarga_lainnya" placeholder="Sebutkan penyakit lainnya" value="{{ old('penyakit_keluarga_lainnya', $penyakitKeluargaLainnya ?? '') }}" class="w-full rounded-xl border border-[#B9257F] px-4 py-2 text-sm text-[#1D1D1D] placeholder-[#8C8C8C]" />
                            </div>
                        </div>
                    </div>
