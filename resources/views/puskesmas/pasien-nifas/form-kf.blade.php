...
<head>
    ...
    @vite([
        ...
        'resources/js/puskesmas/kf-form.js'
    ])
</head>
            ...
            <div class="bg-white rounded-2xl border border-[#E9E9E9] p-6">
                ...
                <form action="{{ route('puskesmas.pasien-nifas.catat-kf', ['type' => 'rs', 'id' => $pasienNifas->id, 'jenisKf' => $jenisKf]) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div>
                            ...
                            <input type="number" name="sbp" id="sbp" value="{{ old('sbp') }}"
                                   ...
                                   placeholder="120">
                            @error('sbp') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="dbp" id="dbp" value="{{ old('dbp') }}"
                                   ...
                                   placeholder="80">
                            @error('dbp') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        @error('keadaan_umum') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>

                    <!-- Tanda Bahaya -->
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-[#1D1D1D] mb-2">Tanda Bahaya yang Ditemukan</label>
                        <textarea name="tanda_bahaya" rows="3"
                                  class="w-full px-4 py-3 border border-[#E9E9E9] rounded-xl focus:border-[#B9257F] focus:ring focus:ring-[#B9257F]/20"
                                  placeholder="Tuliskan tanda bahaya jika ada">{{ old('tanda_bahaya') }}</textarea>
                        @error('tanda_bahaya') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>
