...
<div class="p-8 max-w-5xl mx-auto">
  <div class="mb-6 flex items-center justify-between">
    <h1 class="text-2xl font-bold">Edit Akun ({{ ucfirst($tab) }})</h1>
  ...
  <div class="bg-[#FFF0F5] rounded-2xl p-8">
    <form method="POST" action="{{ route('dinkes.data-master.update',['user'=>$data->id,'tab'=>$tab]) }}" class="grid grid-cols-2 gap-6 text-sm">
      @csrf
      @method('PUT')
      ...
      <div>
        ...
        <input name="phone" value="{{ old('phone',$data->phone) }}" class="w-full border border-pink-400 rounded-full px-4 py-2 mt-1">
      </div>
