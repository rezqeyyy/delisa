    ...
    <div class="min-h-screen flex">
        ...
        <main class="w-full lg:ml-[260px] p-4 sm:p-6 lg:p-8 space-y-6">
            ...
            <section class="bg-white rounded-2xl shadow-md p-4 sm:p-5">
                ...
                {{-- 
                    Mode mobile: tampil sebagai beberapa kartu (card).
                    - md:hidden → hanya muncul di layar < md.
                --}}
                <div class="grid gap-3 md:hidden">
                    @forelse($riwayatKehamilan as $r)
                        <div class="rounded-xl border border-[#EFEFEF] p-3">
                            {{-- Baris atas kartu: tahun kehamilan dan kehamilan ke-berapa --}}
                            <div class="flex items-center justify-between">
                                <div class="font-medium">
                                    Tahun <span class="tabular-nums">{{ $r->tahun_kehamilan }}</span>
                                </div>
                                <div class="text-xs text-[#7C7C7C]">
                                    Ke-<span class="tabular-nums">{{ $r->kehamilan }}</span>
                                </div>
                            </div>

                            {{-- 
                                Detail kehamilan:
                                - grid 2 kolom, label di kiri, nilai di kanan.
                            --}}
                ...
                {{-- 
                    Mode desktop (≥ md): tampil sebagai tabel dengan scroll horizontal jika lebar.
                    - hidden md:block → hanya pada layar medium ke atas.
                --}}
                <div class="hidden md:block overflow-x-auto">
                    <table class="min-w-[720px] w-full text-sm">
                        ...
                        <tbody class="divide-y divide-[#F0F0F0]">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="py-3 text-[#7C7C7C]">
                                        Tidak ada data.
                                    </td>
                                </tr>
                            @endforelse
