            ...
            if ($pasien) {
                ...
                return response()->json([
                    ...
                    'pasien' => [
                        ...
                        // FIX: status_perkawinan di DB boolean (true/false) → mapping ke string dropdown
                        'status_perkawinan'     => is_bool($pasien->status_perkawinan)
                            ? ($pasien->status_perkawinan ? 'Menikah' : 'Belum Menikah')
